...
class FullQuantConfig:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "stock_pool_profiles": {
                name: profile.__dict__ for name, profile in self.stock_pool_profiles.items()
            },
...
def make_pool_profile(pool_name, Index_filter, index_code, min_liquidity_percentile, min_market_cap_percentile):
...
CSI300_most_basic_profile = make_pool_profile('institutional_stock_pool', True, '000300.SH', 0, 0)
CSI500_most_basic_profile = make_pool_profile('institutional_stock_pool', True, '000905.SH', 0, 0)
# 用于我需要在最真实的环境，交易，需要必须要过滤流动差劲的
pool_for_massive_test_CSI800_profile = make_pool_profile('institutional_stock_pool', True, '000905.SH', 0.1, 0.05)
pool_for_massive_test_MICROSTRUCTURE_profile = make_pool_profile('microstructure_stock_pool', True, '000905.SH', 0.2, 0.2)
